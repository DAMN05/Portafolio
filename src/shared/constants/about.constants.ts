...
export const SKILLS_DATA: Skill[] = [
  {
    ...
    level: "Avanzado",
    description:
      "+2 años, usado en proyectos reales. Experiencia con hooks, context, y performance optimization.",
    yearsOfExperience: "2+",
    color: "#61DAFB",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+2 años desarrollando aplicaciones full-stack con SSR, SSG, y API routes.",
    yearsOfExperience: "2+",
    color: "#ffffffff",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+1 año usando TypeScript para aplicaciones escalables con tipado robusto.",
    yearsOfExperience: "1+",
    color: "#3178C6",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+2 años creando interfaces responsive y modernas con utility-first CSS.",
    yearsOfExperience: "2+",
    color: "#06B6D4",
  },

  {
    ...
    level: "Avanzado",
    description:
      "+1 año desarrollando APIs REST y servicios backend con arquitectura limpia.",
    yearsOfExperience: "1+",
    color: "#339933",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+1 año creando APIs escalables con middleware personalizados y mejores prácticas.",
    yearsOfExperience: "1+",
    color: "#ffffffff",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+1 año trabajando con bases de datos NoSQL, agregaciones y optimización de queries.",
    yearsOfExperience: "1+",
    color: "#47A248",
  },
  {
    ...
    level: "Intermedio",
    description:
      "+1 año trabajando con bases de datos relacionales, SQL avanzado y migraciones.",
    yearsOfExperience: "1+",
    color: "#4169E1",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+1 año desarrollando APIs, procesamiento de datos y librerías científicas personalizadas.",
    yearsOfExperience: "1+",
    color: "#3776AB",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+1 año creando APIs REST modernas, rápidas y con documentación automática.",
    yearsOfExperience: "1+",
    color: "#009688",
  },

  {
    ...
    level: "Intermedio",
    description:
      "+1 año creando experiencias 3D interactivas, iluminación y animaciones complejas.",
    yearsOfExperience: "1+",
    color: "#908c8cff",
  },

  {
    ...
    level: "Intermedio",
    description:
      "+1 año creando animaciones fluidas y profesionales con ScrollTrigger.",
    yearsOfExperience: "1+",
    color: "#88CE02",
  },

  {
    ...
    level: "Avanzado",
    description:
      "+2 años usando control de versiones, branching strategies y resolución de conflictos.",
    yearsOfExperience: "2+",
    color: "#F05032",
  },
  {
    ...
    level: "Intermedio",
    description:
      "+1 año containerizando aplicaciones y orquestando servicios con docker-compose.",
    yearsOfExperience: "1+",
    color: "#2496ED",
  },
  {
    ...
    level: "Avanzado",
    description:
      "+2 años diseñando interfaces UI/UX, prototipos interactivos y sistemas de diseño.",
    yearsOfExperience: "2+",
    color: "#F24E1E",
  },
];
...
export const EXPERIENCE_DATA: Experience[] = [
  {
    ...
    isCurrent: false,
    description:
      "Desarrollo de un sistema de gestión de inventario moderno que combina tecnologías web robustas (FastAPI + Next.js) con el poder de los LLMs (Large Language Models) y MCP (Model Context Protocol) para crear una experiencia intuitiva, conversacional y personalizada.",
    highlights: [
  ...
  },
  {
    ...
    title:
      "Fullstack & Scientific Developer — Estación Meteorológica Inteligente UV",
