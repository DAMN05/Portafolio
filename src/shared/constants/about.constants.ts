...
export const SKILLS_DATA: Skill[] = [
  ...
  },
  {
    ...
    category: 'frontend',
    level: 'Avanzado',
    description: '+1 años usando TypeScript para aplicaciones escalables con tipado robusto.',
    yearsOfExperience: '1+',
    color: '#3178C6',
  },
  {
  ...
  // Backend
  {
    ...
    category: 'backend',
    level: 'Avanzado',
    description: '+1 años desarrollando APIs REST y servicios backend con arquitectura limpia.',
    yearsOfExperience: '1+',
    color: '#339933',
  },
  {
    ...
    category: 'backend',
    level: 'Avanzado',
    description: '+1 años creando APIs escalables con middleware personalizados y mejores prácticas.',
    yearsOfExperience: '1+',
    color: '#ffffffff',
  },
  {
    ...
    category: 'backend',
    level: 'Avanzado',
    description: '+1 años trabajando con bases de datos NoSQL, agregaciones y optimización de queries.',
    yearsOfExperience: '1+',
    color: '#47A248',
  },
  {
  ...
  },
  {
    ...
    category: 'backend',
    level: 'Avanzado',
    description: '+1 años desarrollando APIs, procesamiento de datos y librerías científicas personalizadas.',
    yearsOfExperience: '1+',
    color: '#3776AB',
  },
  {
  ...
  // 3D & Animation
  {
    ...
    category: '3d',
    level: 'Intermedio',
    description: '+1 años creando experiencias 3D interactivas, iluminación y animaciones complejas.',
    yearsOfExperience: '1+',
    color: '#908c8cff',
  },
  
  {
    ...
    category: '3d',
    level: 'Intermedio',
    description: '+1  años creando animaciones fluidas y profesionales con ScrollTrigger.',
    yearsOfExperience: '1+',
    color: '#88CE02',
  },
