...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    shortDescription:
      "Plataforma de streaming responsiva con exploración de catálogo, reproducción, favoritos, comentarios y subtítulos.",
    longDescription:
  ...
  },
  {
    ...
    title: "PORTAFOLIO 3D",
    shortDescription:
      "Portfolio moderno para mostrar proyectos, habilidades y experiencia profesional.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Aplicación moderna para gestionar tareas con categorías, prioridades y subtareas.",
    longDescription:
...

  {
    ...
    shortDescription:
      "Sistema web moderno y escalable para gestión de inventarios con IA conversacional, arquitectura de 3 capas y módulos completos para control de stock, proveedores, bodegas, kardex y reportes.",
...
El proyecto se desarrolla mediante metodologías ágiles con sprints quincenales, reuniones interdisciplinarias constantes con el grupo de electrónica (responsables del hardware y sensores) y enfoque modular para facilitar su despliegue en múltiples campus.`,
    ...
    images: ["/images/projects/ET/interfaz.png"],

    thumbnail: "/images/projects/ET/interfaz.png",

    featured: true,
    completedAt: ["2025-01", "2025-04"],
