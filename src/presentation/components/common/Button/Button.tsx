...
export const Button = ({ 
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/50 hover:scale-105',
    secondary: 'bg-secondary text-white hover:bg-secondary/90 hover:shadow-lg hover:shadow-secondary/50 hover:scale-105',
